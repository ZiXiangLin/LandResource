...
import arcpy
import arceditor
#this is required to create a mosaic dataset from images
...
username = "arcgis"
password = "123456"
#ImageSource="G:\\__ArcSer__\\Data\\Cov"  # the folder of input images
ImageSource=sys.argv[1]
#MyWorkspace="G:\\__ArcSer__\\ServiceOperationPyScript\\workspace" # the folder for mosaic dataset and the service defintion draft file
MyWorkspace=sys.argv[4]
#GdbName="111.gdb"
GdbName=sys.argv[2]
...
#con = os.path.join(MyWorkspace, "localhost.ags")
SrsLookup = {
...
try:
    arcpy.mapping.CreateGISServerConnectionFile("PUBLISH_GIS_SERVICES",MyWorkspace+'/',host+".ags",serverURL,"ARCGIS_SERVER",username=username,password=password)
except Exception, e:
    print e.message   
